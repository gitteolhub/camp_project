...
public class BoardVO implements Serializable{
	...
	@GeneratedValue(strategy = GenerationType.SEQUENCE,
		    generator = "INQUIRY_BOARD_SEQ_GENERATOR")
			@SequenceGenerator(
			name = "INQUIRY_BOARD_SEQ_GENERATOR",
			sequenceName = "inquiry_board_seq",
			initialValue = 1,
			allocationSize = 1)
    ...
    public BoardVO(Map<String, Object> map) {
    	...
    	log.info("[BoardVO][BoardVO 오버로딩 생성자 : Map to VO]");
    ...
    public BoardVO(Map<String, Object> map, MultipartFile boardFile) {
    	...
    	log.info("[BoardVO2][BoardVO 오버로딩 생성자 : Map to VO]");
        ...
        log.info("[BoardVO2][map.get(\"boardOriginal\")]: {}", map.get("boardOriginal"));

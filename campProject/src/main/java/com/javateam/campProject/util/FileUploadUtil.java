...
public class FileUploadUtil {
	...
	public static String fileSave(String uploadPath, MultipartFile file) throws IllegalStateException, IOException {
		...
		log.info("[FileUploadUtil][fileSave]");
		
		// 업로드 경로에 해당하는 file 객체 생성
	...
	public static String getExtension(String fileName) {
		...
		log.info("[FileUploadUtil][getExtension]");
	...
	private static String calcPath(String uploadPath) {
		...
		log.info("[FileUploadUtil][calcPath]");
        ...
        // 저장 경로 단순화 2024/09/03 → 2024.09.03
        String storePath = File.separator + cal.get(Calendar.YEAR) + "."
        				 + new DecimalFormat("00").format(cal.get(Calendar.MONTH)+1) + "."
        				 + new DecimalFormat("00").format(cal.get(Calendar.DATE));

        makeDir(uploadPath, storePath);

        log.info("[FileUploadUtil][storePath]: {}", storePath);
	...
	private static void makeDir(String uploadPath, String... paths) {
		...
		log.info("[FileUploadUtil][makeDir]");
	...
	private static String makeFilePath(String uploadPath, String path, String fileName) throws IOException {
		...
		log.info("[FileUploadUtil][makeFilePath]");
	...
	private static String makeThumbnail(String uploadPath, String path, String fileName) throws Exception {
		...
		log.info("[FileUploadUtil][makeThumbnail]");
	...
	public static String encodeFilename(String originalfileName) {
		...
		log.info("[FileUploadUtil][encodeFilename]");
        ...
        log.info("[FileUploadUtil][실제 저장될 업로드 파일명] : {}", saveFilename);
